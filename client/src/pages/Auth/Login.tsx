        ...
        <div className="flex h-screen bg-primary-Dark-gray text-primary-off-white items-center justify-center gap-56">     
            ...
            <div className="flex flex-col gap-4 text-center align-middle">
                <h1 className="font-sans text-3xl font-medium">
                    <span className="font-bold text-4xl text-secondary-purple">L</span>ink
                    <span className="font-bold text-4xl text-secondary-purple">W</span>ave
                </h1>
            ...
            <form className="px-8 py-8 bg-primary-off-white rounded-[32px]">
                ...
                <div className="relative mt-6 flex flex-col">
                    ...
                    {password.length > 0 && ( // Show validation message if there is any input
                        <div className="mt-2">
